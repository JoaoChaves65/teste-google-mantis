...
COPY --from=builder /app/packages/api-vulnerable/dist ./packages/api-vulnerable/dist
COPY --from=builder /app/packages/api-vulnerable/node_modules ./packages/api-vulnerable/node_modules
COPY --from=builder /app/packages/core/dist ./packages/core/dist
COPY --from=builder /app/packages/core/node_modules ./packages/core/node_modules
COPY --from=builder /app/package.json ./
COPY --from=builder /app/node_modules ./node_modules

WORKDIR /app/packages/api-vulnerable
