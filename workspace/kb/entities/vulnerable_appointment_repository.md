...
Intentionally vulnerable repository implementation for demonstrating SQL
Injection vulnerabilities. Located in the shared core package to be used by the
vulnerable API variant.
...
- **NOT used by**: `api-secure` (uses `PgAppointmentRepository` with
