...
## Overview
Customer management routes in the vulnerable API variant. Contains IDOR and Mass Assignment vulnerabilities.
...
### IDOR (Lines 66-100)
```typescript
router.get('/:id', vulnerableRequireRole(UserRole.ADMIN, UserRole.BARBER, UserRole.CUSTOMER), async (req, res) => {
...
## Secure Contrast
See [Customer Routes (Secure)](../entities/customer_routes_secure.md) for secure implementation.
