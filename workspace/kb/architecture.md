...
**Vulnerable API** runs in parallel on port 3002 with identical domain layer but **intentionally weakened** HTTP layer.
...
Network: `barberlab-network` (bridge), all services communicate via service names.
...
*Document generated by Mantis Architecture pass 1 — KB_SNAPSHOT: snap_20250829_01*