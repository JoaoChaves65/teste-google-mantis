...
name: mantis-report
description: >-
  Generates a human-readable security review packet compiled from confirmed
  findings and exploit chains. Use at the end of a review cycle to produce
  stakeholder-facing documentation. Don't use for auditing code or verifying
  patches directly.
---
...
3. **Generate Review Packet:**
   ...
   - **Report Header & Disclaimer:** At the very top of the report (before the
     ...
     **Snapshot provenance banners — emit these BEFORE item 1 below, at the very
     ...
     2. Include a prominent disclaimer note stating: _“This report was
        ...
        matter expert before deployment or disclosure.”_
